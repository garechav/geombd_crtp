...
namespace geo {
  ...
  public:
    ...
    EIGEN_ALWAYS_INLINE void
    Accel01(typename Eigen::MatrixBase<Vector6Type> & AdAj_,
            typename Eigen::MatrixBase<Vector6Type> & Aa_) {
      static_cast<Derived*>(this)->runAccel01(AdAj_.derived(), Aa_.derived());
    }
    ...
    Accel02(ScalarType* ddq_,
      ...
      static_cast<Derived*>(this)->runAccel02(ddq_, A_.derived(), D_q_A_.derived(), D_dq_A_.derived(), D_q_ddq_.derived(), D_dq_ddq_.derived());
    }
